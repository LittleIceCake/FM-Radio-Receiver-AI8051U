...
本项目基于**RDA5807FP调频收音机芯片**与**AI8051U单片机**设计的一款便携式FM收音机。系统支持全球50-108MHz频段接收，具备频率调节、音量控制、信号强度检测、RTC时钟显示等功能，并通过TFT屏幕提供友好的用户交互界面。
...
- **轻量 UI 系统**：使用标志位 + 定时器局部刷新，显著减少 8051 系列 MCU 的刷新压力。
